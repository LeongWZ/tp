...
with(this){return _c('ul',[_c('li',[_v("is a social worker tasked with helping low-income families")]),_v(" "),_c('li',[_v("has a need to manage a significant number of contacts")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": streamlines the process of social workers contacting and assisting families")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I can …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("new user")]),_v(" "),_c('td',[_v("view the how to guide")]),_v(" "),_c('td',[_v("familiarise myself with the functionalities of the app.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("social worker")]),_v(" "),_c('td',[_v("add information of different families")]),_v(" "),_c('td',[_v("keep track of families requiring assistance in one place.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("social worker")]),_v(" "),_c('td',[_v("view the information of different families I have added")]),_v(" "),_c('td',[_v("retrieve their information more quickly.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("social worker")]),_v(" "),_c('td',[_v("delete the information of a family")]),_v(" "),_c('td',[_v("remove the data of a family that I no longer need to keep track of.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("social worker")]),_v(" "),_c('td',[_v("edit a family's information")]),_v(" "),_c('td',[_v("keep their information up-to-date for future use.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("social worker")]),_v(" "),_c('td',[_v("tag families")]),_v(" "),_c('td',[_v("manage and organize families according to their needs.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("social worker")]),_v(" "),_c('td',[_v("filter through the list of families")]),_v(" "),_c('td',[_v("navigate the contact list more efficiently.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("social worker")]),_v(" "),_c('td',[_v("sort families")]),_v(" "),_c('td',[_v("view families in a more suitable order.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("social worker")]),_v(" "),_c('td',[_v("toggle between list view and individual family view")]),_v(" "),_c('td',[_v("focus on a specific family's information when I need to.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("social worker")]),_v(" "),_c('td',[_v("create custom command aliases for frequently used commands")]),_v(" "),_c('td',[_v("execute commands faster and reduce my typing effort.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("social worker")]),_v(" "),_c('td',[_v("archive families that no longer need assistance")]),_v(" "),_c('td',[_v("keep my contact list focused on active cases.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("social worker")]),_v(" "),_c('td',[_v("see the overall statistics of families based on location")]),_v(" "),_c('td',[_v("allocate my manpower better to areas with more help needed.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("social worker")]),_v(" "),_c('td',[_v("synchronize the app with my personal calendar")]),_v(" "),_c('td',[_v("view all my appointments and reminders in one place.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("social worker")]),_v(" "),_c('td',[_v("attach documents or images to family profiles")]),_v(" "),_c('td',[_v("make all relevant information accessible within each family’s contact details.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("social worker")]),_v(" "),_c('td',[_v("generate and export reports on family progress or case notes")]),_v(" "),_c('td',[_v("share updates with my team or supervisors efficiently.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("social worker")]),_v(" "),_c('td',[_v("share contacts")]),_v(" "),_c('td',[_v("allow multiple parties to assist the families at once.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("SocialBook")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Add new family")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User enters the command to add a family with the specified details")])]),_v(" "),_c('li',[_c('p',[_v("SocialBook adds the family and displays the newly added family")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. SocialBook detects missing or invalid input.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. SocialBook displays an error message and prompts the user to try again")])]),_v(" "),_c('li',[_c('p',[_v("2a2. User corrects the input and enters the command again")]),_v(" "),_c('p',[_v("Steps 2a1-2a2 are repeated until the user enters the correct input")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("2b. SocialBook detects a duplicate family entry.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2b1. SocialBook displays an error message showing the duplicated family")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: View information of different families")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User enters the command to view all families")])]),_v(" "),_c('li',[_c('p',[_v("SocialBook displays all families whose info has been added")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. No families have been added to SocialBook yet.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. SocialBook displays a message to inform the user that no family has been added by them yet")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Delete information of different families")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User indicates family whose member they want to delete")])]),_v(" "),_c('li',[_c('p',[_v("SocialBook displays all family members in that family")])]),_v(" "),_c('li',[_c('p',[_v("User selects and deletes the member")])]),_v(" "),_c('li',[_c('p',[_v("SocialBook removes the member’s details from the display")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. SocialBook detects no such family exist in the list.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. SocialBook informs user that no such family exist in the list")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("3a. User selects the primary contact of the family to be deleted.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. SocialBook informs user they cannot delete primary contact and to swap it to someone else if they wish to do so")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Display command manual")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User keys in command to open command manual")])]),_v(" "),_c('li',[_c('p',[_v("SocialBook displays command manual")])]),_v(" "),_c('li',[_c('p',[_v("User keys in command to close command manual")])]),_v(" "),_c('li',[_c('p',[_v("SocialBook displays previously shown screen")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User chooses more detailed manual.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. SocialBook displays detailed command manual")])]),_v(" "),_c('li',[_c('p',[_v("1a2. User keys in command to close command manual")])]),_v(" "),_c('li',[_c('p',[_v("1a3. SocialBook displays previously shown screen")])])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Edit existing information of a family")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses which information fields to update")])]),_v(" "),_c('li',[_c('p',[_v("User only enters the fields he wishes to update")])]),_v(" "),_c('li',[_c('p',[_v("SocialBook only updates the fields which user had updated and displays all information about the family")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. SocialBook suggests a list of fields as user is typing input.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. User enters one field")])]),_v(" "),_c('li',[_c('p',[_v("2a2. SocialBook shows possible fields to be updated")])]),_v(" "),_c('li',[_c('p',[_v("2a3. User types finishes the field he wishes to update")])]),_v(" "),_c('li',[_c('p',[_v("2a4. SocialBook stops showing possible fields")])]),_v(" "),_c('li',[_c('p',[_v("2a5. User enters updated value")]),_v(" "),_c('p',[_v("If User chooses to update other fields, repeat step 2a1-2a4.\nOtherwise, use case resumes from step 3.")])]),_v(" "),_c('li',[_c('p',[_v("3a. SocialBook detects an error in the entered data.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. SocialBook should not update any fields")])]),_v(" "),_c('li',[_c('p',[_v("3a2. SocialBook displays errors encountered with respect to the field")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("API")]),_v(": Application programming interfaces, which defines the standards and protocols that allow different software components to communicate with one another.")]),_v(" "),_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("Custom command aliases")]),_v(": Alternative command names that work the same if called as the actual command name.")]),_v(" "),_c('li',[_c('strong',[_v("Breadth-first iterative development")]),_v(": Evolves all major components and functionality areas in parallel, producing a working product at the end of each iteration")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Fri, 8 Nov 2024, 14:21:57 GMT+8]")])])])}
}];
